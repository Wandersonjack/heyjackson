          ...
          <div className="hero-container">
            <div>
              <h1 className="display1 text-center darkGrey item-hero">
                Hello, I'm Wanderson Jackson
              </h1>
            </div>
            <h3 className="display3 text-center darkGrey hero-subtitle">
            A Product designer, passionate about solving complex problems and making the user experience delightful.
            </h3>
            <img
